...
| AVX2_256-float-cpu-mpi.tar.bz2 | AVX2_256 | Single/Mixed | CPU + MPI |
| AVX_512-float-cpu-mpi.tar.bz2 | AVX_512 | Single/Mixed | CPU + MPI |
...
## MPI Builds (mpi and cpu-mpi variants)
